...
public class CursoControllerUnitTest {
    ...
    public void testListarCursos() {
        ...
        ResponseEntity<Response<List<CursoEntity>>> cursos = restTemplate.withBasicAuth(USERNAME,PASSWORD).exchange(
    ...
    public void testConsultarCurso() {
        ...
        ResponseEntity<Response<CursoEntity>> cursoResponse = restTemplate.withBasicAuth(USERNAME,PASSWORD).exchange(
    ...
    public void testCadastrarCurso() {
        ...
        ResponseEntity<Response<Boolean>> curso = restTemplate.withBasicAuth(USERNAME,PASSWORD).exchange(
